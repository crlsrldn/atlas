  ...
  const features = [
    {
      ...
      description: "We instantly parse your TorBox cache to serve lightning-fast streaming links without proxying media bytes.",
    },
    {
      iconPath: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z",
      color: "teal",
      title: "Smart Verification",
      description: "Atlas analyzes structural evidence to surface the most reliable, highest quality source for your device.",
    },
    {
      iconPath: "M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z",
      color: "emerald",
      title: "Secure & Private",
      description: "API keys are heavily encrypted. All telemetry is 100% anonymized to protect your viewing habits.",
    },
  ];
...
<div class="flex flex-col">
  ...
  <section class="relative flex flex-col items-center justify-center min-h-[88vh] px-4 text-center overflow-hidden bg-[#12141b]">
    ...
    <div class="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-emerald-900/10 via-[#12141b] to-[#12141b] pointer-events-none"></div>
    ...
    <div class="relative z-10 max-w-4xl mx-auto space-y-10 animate-fade-in-up">
      ...
      <div class="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
        <a href="/login" class="btn-primary text-base px-8 py-4 rounded-2xl shadow-glow-md">
          Get Started
        </a>
      </div>
    </div>
    ...
    <div class="max-w-5xl mx-auto">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        {#each features as feature}
          ...
          <div class="glass-card group p-8 flex flex-col gap-5 {c.border} transition-all duration-300 hover:-translate-y-1 bg-[#1a1c23]/80">
            <div class="icon-box {c.bg}">
              <svg class="w-6 h-6 {c.icon}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.75">
